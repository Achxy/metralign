"""Command-line interface for Metralign coordinate inference."""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Locate a reference field-of-view center in a search image."
    )
    ...
    parser.add_argument(
        "--prior-center-x",
        type=float,
        help="optional external stage-position prior in search-image pixels",
    )
    parser.add_argument(
        "--prior-center-y",
        type=float,
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    if (args.prior_center_x is None) != (args.prior_center_y is None):
        parser.error("--prior-center-x and --prior-center-y must be provided together")
    return args
    ...
    try:
        ...
        result = localize(
            ...
            LocalizationConfig(
                ...
                prior_center_x=args.prior_center_x,
                prior_center_y=args.prior_center_y,
            ),
        )
